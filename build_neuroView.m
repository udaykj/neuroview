% Script to build the complete neuroView.m file

% Open the file for appending
fid = fopen('neuroView_complete.m', 'w');
...
disp('Script created to build the complete neuroView.m file.');
disp('The file is too large to process in one go.');
disp('You can copy the original code you provided directly into neuroView.m');